...
%type <nodo> prog bloque declaraciones sentencias sentencia decl_var asignacion expr VALOR
...
asignacion:
      ID T_ASIGNACION expr T_PUNTOC { $$ = nodo_binario(AST_OP, (AstValor){.op='='}, nodo_hoja(AST_ID, $1), $3); }
    ;
